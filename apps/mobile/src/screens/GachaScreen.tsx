...
function DrawingIndicator({
  ...
  colors: { primary: string; card: string; text: string; textMuted: string };
}) {
  ...
  return (
    <View
      style={{ alignItems: 'center', justifyContent: 'center', width: 220 }}
    >
      <View
        style={{
          width: 64,
...
function AnimatedCard({
  ...
  return (
    ...
    >
      ...
      <Animated.Image
        source={getCharacterImageSource(result.grade, result.type)}
        style={{
          width: '100%',
          height: 88,
          marginTop: 8,
          marginBottom: 8,
          transform: getCharacterImageTransform(result.grade, result.type, 88),
        }}
        resizeMode="contain"
      />
      <Text
      ...
      <Text style={{ fontSize: 11, fontWeight: '700', color: gc }}>
